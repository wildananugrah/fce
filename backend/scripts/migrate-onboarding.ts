 ...
 *   - seenCoachMarks (if []):                 →
 *     ["dashboard","brands","products","generate","campaigns","topics","brand-new","product-new","topic-library"]
 *
...
const COACH_MARK_KEYS = ["dashboard", "brands", "products", "generate", "campaigns", "topics", "brand-new", "product-new", "topic-library"];
